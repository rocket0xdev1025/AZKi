(() => {
  ...
  const d = document.getElementById("sound");
  d.volume = 0.6;
  document.querySelector(".sound-box");
  let h = !1;
  document.addEventListener("keydown", function (t) {
    document.documentElement.classList.contains("sound-play") ||
      h ||
      ((h = !0),
      d.play(),
      document.documentElement.classList.add("sound-play"));
  }),
  ...
  document.getElementById("play-pause").addEventListener("click", () => {
    h || (h = !0),
      document.documentElement.classList.contains("sound-play")
        ? (d.pause(), document.documentElement.classList.remove("sound-play"))
        : (d.play(), document.documentElement.classList.add("sound-play"));
  }),
    (window.FLS = !1),
        ...
        if ("click" === e.type) {
          ...
          if (o.closest("[data-goto]")) {
            const a = o.closest("[data-goto]"),
              ...
              r = a.dataset.gotoTop ? parseInt(a.dataset.gotoTop) : 0;
            if (t.fullpage) {
              const e = document
                  .querySelector(`${s}`)
